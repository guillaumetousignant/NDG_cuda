...
auto SEM::Host::Hilbert::deduct_first_element_status(std::size_t outgoing_side) -> SEM::Host::Hilbert::Status {
...
auto SEM::Host::Hilbert::deduct_last_element_status(std::size_t incoming_side) -> SEM::Host::Hilbert::Status {
...
auto SEM::Host::Hilbert::deduct_element_status(std::size_t incoming_side, std::size_t outgoing_side) -> SEM::Host::Hilbert::Status {
...
auto SEM::Host::Hilbert::child_order(SEM::Host::Hilbert::Status parent_status, int rotation) -> std::array<std::size_t, 4> {
    constexpr std::array<std::array<std::array<std::size_t, 4>, 4>, 4> child_orders {{
        {{
            {0, 3, 2, 1},
            {0, 1, 2, 3},
            {2, 1, 0, 3},
