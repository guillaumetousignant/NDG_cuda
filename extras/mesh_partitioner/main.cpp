...
auto read_su2_mesh(const fs::path in_file) -> MeshPart_t {
    ...
    if (!wall.empty()) {
        ...
        boundary_names[wall_boundary_index][4] = '\0';
    ...
    if (!symmetry.empty()) {
        ...
        boundary_names[symmetry_boundary_index][8] = '\0';
    ...
    if (!inflow.empty()) {
        ...
        boundary_names[inflow_boundary_index][6] = '\0';
    ...
    if (!outflow.empty()) {
        ...
        boundary_names[outflow_boundary_index][7] = '\0';
