...
ux_fig.savefig(save_path / "Ux.svg", format='svg', transparent=True)
ux_fig.savefig(save_path / "Ux.png", format='png', transparent=True)
...
ux_prime_fig.savefig(save_path / "Ux_prime.svg", format='svg', transparent=True)
ux_prime_fig.savefig(save_path / "Ux_prime.png", format='png', transparent=True)
...
intermediate_fig.savefig(save_path / "Intermediate.svg", format='svg', transparent=True)
intermediate_fig.savefig(save_path / "Intermediate.png", format='png', transparent=True)
...
N_fig.savefig(save_path / "N.svg", format='svg', transparent=True)
N_fig.savefig(save_path / "N.png", format='png', transparent=True)
...
sigma_fig.savefig(save_path / "Sigma.svg", format='svg', transparent=True)
sigma_fig.savefig(save_path / "Sigma.png", format='png', transparent=True)
...
refine_fig.savefig(save_path / "Refine_flag.svg", format='svg', transparent=True)
refine_fig.savefig(save_path / "Refine_flag.png", format='png', transparent=True)
...
coarsen_fig.savefig(save_path / "Coarsen_flag.svg", format='svg', transparent=True)
coarsen_fig.savefig(save_path / "Coarsen_flag.png", format='png', transparent=True)
...
error_fig.savefig(save_path / "Error_estimation.svg", format='svg', transparent=True)
error_fig.savefig(save_path / "Error_estimation.png", format='png', transparent=True)
...
delta_x_fig.savefig(save_path / "Delta_x.svg", format='svg', transparent=True)
delta_x_fig.savefig(save_path / "Delta_x.png", format='png', transparent=True)
