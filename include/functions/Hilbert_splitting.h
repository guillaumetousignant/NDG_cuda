...
namespace SEM { namespace Host { namespace Hilbert {
     ...
     */
    auto deduct_first_element_status(std::size_t outgoing_side) -> Status;
     ...
     * @return Status Geometric arrangement of the cell.
     */
    auto deduct_last_element_status(std::size_t incoming_side) -> Status;
     ...
     * @return Status Geometric arrangement of the cell.
     */
    auto deduct_element_status(std::size_t incoming_side, std::size_t outgoing_side) -> Status;
     ...
     */
    auto child_order(Status parent_status, int rotation) -> std::array<std::size_t, 4>;
