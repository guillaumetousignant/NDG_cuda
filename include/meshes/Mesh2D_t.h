...
namespace SEM { namespace Host { namespace Meshes {
    ...
    auto get_MPI_interfaces_adaptivity(size_t n_MPI_interface_elements, size_t n_domain_elements, size_t n_processes, const SEM::Host::Entities::Element2D_t* elements,  const SEM::Host::Entities::Face2D_t* faces, const SEM::Host::Entities::Vec2<hostFloat>* nodes, const size_t* MPI_interfaces_origin, const size_t* MPI_interfaces_origin_side, const size_t* MPI_interfaces_destination, const int* MPI_process, const size_t* origin_process_size, const size_t* destination_process_size, const size_t* destination_process_offset, int* N, unsigned int* elements_splitting, bool* elements_refining_without_splitting, int max_split_level, int N_max) -> void;
