...
namespace SEM { namespace Host { namespace Meshes {
    ...
    auto split_mpi_outgoing_interfaces(size_t n_MPI_interface_elements, size_t n_domain_elements, size_t n_processes, const SEM::Host::Entities::Element2D_t* elements, const SEM::Host::Entities::Face2D_t* faces, const SEM::Host::Entities::Vec2<hostFloat>* nodes, const size_t* mpi_interfaces_origin, const size_t* mpi_interfaces_origin_side, const size_t* MPI_interfaces_destination, size_t* new_mpi_interfaces_origin, size_t* new_mpi_interfaces_origin_side, const int* MPI_process, const size_t* origin_process_size, const size_t* destination_process_size, const size_t* destination_process_offset, const bool* elements_splitting, const bool* elements_refining_without_splitting, int max_split_level) -> void;
    
    auto split_mpi_incoming_interfaces(size_t n_MPI_interface_elements, size_t n_faces, size_t n_nodes, size_t n_splitting_elements, size_t n_splitting_faces, size_t offset, SEM::Host::Entities::Element2D_t* elements, SEM::Host::Entities::Element2D_t* new_elements, const size_t* mpi_interfaces_destination, size_t* new_mpi_interfaces_destination, const SEM::Host::Entities::Face2D_t* faces, SEM::Host::Entities::Vec2<hostFloat>* nodes, const std::vector<std::vector<hostFloat>>& polynomial_nodes, const int* N, const bool* elements_splitting, const bool* elements_refining_without_splitting, const bool* elements_creating_node, size_t* elements_new_indices) -> void;
    ...
    auto fill_received_elements(size_t n_elements, size_t element_offset, SEM::Host::Entities::Element2D_t* elements, int maximum_N, const SEM::Host::Entities::Vec2<hostFloat>* nodes, const hostFloat* solution, const size_t* received_node_indices, const std::vector<std::vector<hostFloat>>& polynomial_nodes) -> void;
    ...
    auto move_elements(size_t n_elements_move, size_t n_elements_send_left, size_t n_elements_recv_left, SEM::Host::Entities::Element2D_t* elements, SEM::Host::Entities::Element2D_t* new_elements, const std::vector<bool>& faces_to_delete) -> void;
    ...
    auto add_new_received_neighbour_nodes(size_t n_nodes, size_t n_received_created_nodes, SEM::Host::Entities::Vec2<hostFloat>* nodes, const hostFloat* received_neighbour_nodes, const std::vector<bool>& missing_neighbour_nodes, const std::vector<bool>& missing_nodes, const std::vector<bool>& missing_received_neighbour_nodes, size_t* received_neighbour_nodes_indices, const size_t* received_neighbour_node_received_indices) -> void;
    ...
    auto move_boundary_elements(size_t n_domain_elements, size_t new_n_domain_elements, SEM::Host::Entities::Element2D_t* elements, SEM::Host::Entities::Element2D_t* new_elements, const std::vector<bool>& boundary_elements_to_delete, const std::vector<bool>& faces_to_delete) -> void;
    ...
    auto move_required_boundaries(size_t n_domain_elements, size_t new_n_domain_elements, const std::vector<size_t>& boundary, std::vector<size_t>& new_boundary, std::vector<int>& new_boundary_process, std::vector<size_t>& new_local_index, std::vector<size_t>& new_side, const std::vector<int>& mpi_interfaces_process, const std::vector<size_t>& mpi_interfaces_local_index, const std::vector<size_t>& mpi_interfaces_side, const std::vector<bool>& boundaries_to_delete, const std::vector<bool>& boundary_elements_to_delete) -> void;
