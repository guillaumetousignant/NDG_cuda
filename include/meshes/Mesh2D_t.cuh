...
namespace SEM { namespace Device { namespace Meshes {
    ...
    __global__
    auto add_received_mpi_origins(size_t n_received_elements, size_t element_offset, const size_t* element_n_neighbours, const int* neighbour_procs, size_t* mpi_origins, size_t* mpi_sides, int* mpi_process, const size_t* neighbour_offsets, const size_t* mpi_origins_offsets) -> void;
    
    __global__
    auto add_send_mpi_origins(size_t n_send_elements, int rank, const size_t* element_n_neighbours, const size_t* neighbour_indices, const size_t* neighbour_sides, const int* neighbour_procs, const int* destination_process, size_t* mpi_origins, size_t* mpi_sides, int* mpi_process, const size_t* neighbour_offsets, const size_t* mpi_origins_offsets) -> void;
