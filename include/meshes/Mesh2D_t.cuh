...
namespace SEM { namespace Meshes {
    ...
    __global__
    auto get_transfer_solution(size_t n_elements, SEM::Entities::Element2D_t* elements, int maximum_N, const deviceFloat* solution, const size_t* n_neighbours) -> void;
    
    __global__
    auto put_transfer_solution(size_t n_elements, const SEM::Entities::Element2D_t* elements, int maximum_N, const SEM::Entities::Vec2<deviceFloat>* nodes, deviceFloat* solution, size_t* n_neighbours, deviceFloat* element_nodes) -> void;
