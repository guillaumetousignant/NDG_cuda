...
namespace SEM { namespace Device { namespace Meshes {
    ...
    __global__
    auto fill_received_elements(size_t n_elements, size_t element_offset, size_t n_domain_elements, size_t n_elements_recv_left, size_t n_elements_recv_right, SEM::Device::Entities::Element2D_t* elements, int maximum_N, const SEM::Device::Entities::Vec2<deviceFloat>* nodes, const deviceFloat* solution, const size_t* n_neighbours, const size_t* neighbours_offsets, const size_t* received_node_indices, const size_t* neighbours_indices, const size_t* neighbours_sides, const deviceFloat* polynomial_nodes) -> void;
