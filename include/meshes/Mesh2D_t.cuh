...
namespace SEM { namespace Device { namespace Meshes {
    ...
    __global__
    auto move_required_mpi_origins(size_t n_mpi_origins, size_t n_processes, size_t n_elements_send_left, size_t n_elements_recv_left, const size_t* mpi_origins, size_t* new_mpi_origins, const size_t* mpi_origins_side, size_t* new_mpi_origins_side, int* new_mpi_origins_process, const bool* mpi_origins_to_delete, const size_t* mpi_origins_to_delete_block_offsets, const int* mpi_interfaces_process, const size_t* mpi_interfaces_offset) -> void;
