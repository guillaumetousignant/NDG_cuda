...
namespace SEM { namespace Meshes {
    ...
    __global__
    auto put_transfer_solution(size_t n_elements, SEM::Entities::Element2D_t* elements, int maximum_N, const deviceFloat* solution, const size_t* n_neighbours) -> void;
