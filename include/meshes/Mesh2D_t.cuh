...
namespace SEM { namespace Device { namespace Meshes {
    ...
    __global__
    auto fill_received_elements_faces(size_t n_elements, size_t element_offset, size_t face_offset, size_t n_domain_elements, size_t n_elements_recv_left, size_t n_elements_recv_right, SEM::Device::Entities::Element2D_t* elements, SEM::Device::Entities::Face2D_t* faces, const SEM::Device::Entities::Vec2<deviceFloat>* nodes, const size_t* n_neighbours, const size_t* n_neighbours_left, const size_t* n_neighbours_right, const size_t* neighbours_offsets, const size_t* neighbours_offsets_left, const size_t* neighbours_offsets_right, const size_t* neighbours_indices, const size_t* neighbours_sides, const size_t* face_offsets, const size_t* face_offsets_left, const size_t* face_offsets_right) -> void;
    ...
    __global__
    auto move_required_mpi_origins(size_t n_mpi_origins, size_t n_domain_elements, size_t new_n_domain_elements, size_t n_processes, const size_t* mpi_origins, size_t* new_mpi_origins, const size_t* mpi_origins_side, size_t* new_mpi_origins_side, int* new_mpi_origins_process, const bool* mpi_origins_to_delete, const size_t* mpi_origins_to_delete_block_offsets, const bool* boundary_elements_to_delete, const int* mpi_interfaces_process, const size_t* mpi_interfaces_offset, const size_t* boundary_elements_block_offsets, int boundary_elements_blockSize) -> void;
    ...
    __global__
    auto add_received_mpi_origins(size_t n_received_elements, size_t element_offset, const size_t* element_n_neighbours, const int* neighbour_procs, size_t* mpi_origins, int* mpi_process, const size_t* neighbour_offsets, const size_t* mpi_origins_offsets) -> void;
    
    __global__
    auto add_send_mpi_origins(size_t n_send_elements, int rank, const size_t* element_n_neighbours, const size_t* neighbour_indices, const int* neighbour_procs, const int* destination_process, size_t* mpi_origins, int* mpi_process, const size_t* neighbour_offsets, const size_t* mpi_origins_offsets) -> void;
