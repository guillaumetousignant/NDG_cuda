...
namespace SEM { namespace Device { namespace Meshes {
    class Mesh2D_t {
        public:
            Mesh2D_t(std::filesystem::path filename, int initial_N, int maximum_N, size_t n_interpolation_points, int max_split_level, size_t adaptivity_interval, size_t load_balancing_interval, deviceFloat tolerance_min, deviceFloat tolerance_max, deviceFloat load_balancing_threshold, const SEM::Device::Entities::device_vector<deviceFloat>& polynomial_nodes, std::vector<deviceFloat> worker_weights, const cudaStream_t &stream);
            ...
            SEM::Device::Entities::device_vector<size_t> device_mpi_interfaces_incoming_creating_nodes_refine_array_;
            std::vector<size_t> host_mpi_interfaces_incoming_creating_nodes_array_;
    ...
    __global__
    auto estimate_error(size_t n_elements, SEM::Device::Entities::Element2D_t* elements, deviceFloat tolerance_min, deviceFloat tolerance_max, const deviceFloat* polynomials) -> void;
    ...
    __global__
    auto get_MPI_interfaces_adaptivity(size_t n_MPI_interface_elements, size_t n_domain_elements, size_t n_processes, const SEM::Device::Entities::Element2D_t* elements, const SEM::Device::Entities::Face2D_t* faces, const SEM::Device::Entities::Vec2<deviceFloat>* nodes, const size_t* MPI_interfaces_origin, const size_t* MPI_interfaces_origin_side, const size_t* MPI_interfaces_destination, const int* MPI_process, const size_t* origin_process_size, const size_t* destination_process_size, const size_t* destination_process_offset, int* N, bool* elements_splitting, bool* elements_refining_without_splitting, int max_split_level, int N_max) -> void;
    ...
    __global__
    auto adjust_MPI_incoming_interfaces(size_t n_MPI_interface_elements, size_t nodes_offset, SEM::Device::Entities::Element2D_t* elements, const SEM::Device::Entities::Face2D_t* faces, const size_t* MPI_interfaces_destination, const int* N, SEM::Device::Entities::Vec2<deviceFloat>* nodes, const bool* refine, const bool* refine_without_splitting, const bool* creating_node, const size_t* creating_node_block_offsets, const deviceFloat* polynomial_nodes) -> void;
    ...
    __global__
    auto hp_adapt(size_t n_elements, size_t n_faces, size_t n_nodes, size_t n_splitting_elements, SEM::Device::Entities::Element2D_t* elements, SEM::Device::Entities::Element2D_t* new_elements, const SEM::Device::Entities::Face2D_t* faces, SEM::Device::Entities::Face2D_t* new_faces, const size_t* block_offsets, const size_t* faces_block_offsets, int max_split_level, int N_max, SEM::Device::Entities::Vec2<deviceFloat>* nodes, const deviceFloat* polynomial_nodes, const deviceFloat* barycentric_weights, int faces_blockSize, size_t* elements_new_indices) -> void;
    ...
    __global__
    auto copy_mpi_interfaces_error(size_t n_MPI_interface_elements, SEM::Device::Entities::Element2D_t* elements, SEM::Device::Entities::Face2D_t* faces, const SEM::Device::Entities::Vec2<deviceFloat>* nodes, const size_t* MPI_interfaces_destination, const int* N, const bool* elements_splitting, bool* elements_refining_without_splitting, bool* elements_creating_node) -> void;
    ...
    __global__
    auto split_mpi_outgoing_interfaces(size_t n_MPI_interface_elements, size_t n_domain_elements, size_t n_processes, const SEM::Device::Entities::Element2D_t* elements, const SEM::Device::Entities::Face2D_t* faces, const SEM::Device::Entities::Vec2<deviceFloat>* nodes, const size_t* mpi_interfaces_origin, const size_t* mpi_interfaces_origin_side, const size_t* MPI_interfaces_destination, size_t* new_mpi_interfaces_origin, size_t* new_mpi_interfaces_origin_side, const int* MPI_process, const size_t* origin_process_size, const size_t* destination_process_size, const size_t* destination_process_offset, const bool* elements_splitting, const bool* elements_refining_without_splitting, const size_t* mpi_interface_block_offsets, int max_split_level, const size_t* block_offsets, int elements_blockSize) -> void;
    
    __global__
    auto split_mpi_incoming_interfaces(size_t n_MPI_interface_elements, size_t n_faces, size_t n_nodes, size_t n_splitting_elements, size_t n_splitting_faces, size_t offset, SEM::Device::Entities::Element2D_t* elements, SEM::Device::Entities::Element2D_t* new_elements, const size_t* mpi_interfaces_destination, size_t* new_mpi_interfaces_destination, const SEM::Device::Entities::Face2D_t* faces, SEM::Device::Entities::Vec2<deviceFloat>* nodes, const size_t* faces_block_offsets, const size_t* mpi_interface_block_offsets, const deviceFloat* polynomial_nodes, int faces_blockSize, const int* N, const bool* elements_splitting, const bool* elements_refining_without_splitting, const bool* elements_creating_node, const size_t* creating_node_block_offsets, size_t* elements_new_indices) -> void;
    ...
    __global__
    auto fill_received_elements(size_t n_elements, size_t element_offset, SEM::Device::Entities::Element2D_t* elements, int maximum_N, const SEM::Device::Entities::Vec2<deviceFloat>* nodes, const deviceFloat* solution, const size_t* received_node_indices, const deviceFloat* polynomial_nodes) -> void;
    
    __global__
    auto fill_received_elements_faces(size_t n_elements, size_t element_offset, size_t face_offset, size_t n_domain_elements, size_t n_elements_recv_left, size_t n_elements_recv_right, SEM::Device::Entities::Element2D_t* elements, SEM::Device::Entities::Face2D_t* faces, const SEM::Device::Entities::Vec2<deviceFloat>* nodes, const size_t* n_neighbours, const size_t* n_neighbours_left, const size_t* n_neighbours_right, const size_t* neighbours_offsets, const size_t* neighbours_offsets_left, const size_t* neighbours_offsets_right, const size_t* neighbours_indices, const size_t* neighbours_sides, const int* neighbours_procs, const size_t* face_offsets, const size_t* face_offsets_left, const size_t* face_offsets_right) -> void;

    __global__
    auto get_neighbours(size_t n_elements_send, size_t start_index, size_t n_domain_elements_old, size_t n_wall_boundaries, size_t n_symmetry_boundaries, size_t n_inflow_boundaries, size_t n_outflow_boundaries, size_t n_local_interfaces, size_t n_MPI_interface_elements_receiving, int rank, int n_procs, const SEM::Device::Entities::Element2D_t* elements, const SEM::Device::Entities::Face2D_t* faces, const SEM::Device::Entities::Vec2<deviceFloat>* nodes, const size_t* wall_boundaries, const size_t* symmetry_boundaries, const size_t* inflow_boundaries, const size_t* outflow_boundaries, const size_t* interfaces_destination, const size_t* interfaces_origin, const size_t* mpi_interfaces_destination, const int* mpi_interfaces_process, const size_t* mpi_interfaces_local_indices, const size_t* mpi_interfaces_side, const size_t* offsets, const size_t* n_elements_received_left, const size_t* n_elements_sent_left, const size_t* n_elements_received_right, const size_t* n_elements_sent_right, const size_t* global_element_offset, const size_t* global_element_offset_new, const size_t* global_element_offset_end_new, size_t* neighbours, deviceFloat* neighbours_nodes, int* neighbours_proc, size_t* neighbours_side, int* neighbours_N) -> void;
    ...
    __global__
    auto move_faces(size_t n_faces, size_t n_domain_elements, size_t new_n_domain_elements, size_t n_elements_recv_left, size_t n_elements_recv_right, size_t n_mpi_destinations, int rank, SEM::Device::Entities::Face2D_t* faces, SEM::Device::Entities::Face2D_t* new_faces, const bool* boundary_elements_to_delete, const size_t* boundary_elements_to_delete_block_offsets, int boundary_blockSize, const size_t* mpi_interfaces_destination, const int* mpi_interfaces_new_process_incoming, const size_t* mpi_interfaces_new_local_index_incoming, const size_t* mpi_interfaces_new_side_incoming) -> void;

    __global__
    auto move_required_faces(size_t n_faces, size_t n_domain_elements, size_t new_n_domain_elements, size_t n_elements_send_left, size_t n_elements_send_right, size_t n_elements_recv_left, size_t n_elements_recv_right, size_t new_elements_offset_left, size_t new_elements_offset_right, size_t n_mpi_destinations, int rank, SEM::Device::Entities::Face2D_t* faces, SEM::Device::Entities::Face2D_t* new_faces, const bool* faces_to_delete, const size_t* faces_to_delete_block_offsets, const bool* boundary_elements_to_delete, const size_t* boundary_elements_to_delete_block_offsets, int boundary_blockSize, const size_t* elements_send_destinations_offset_left, const size_t* elements_send_destinations_offset_right, const int* elements_send_destinations_keep_left, const int* elements_send_destinations_keep_right, const size_t* mpi_interfaces_destination, const int* mpi_interfaces_new_process_incoming, const size_t* mpi_interfaces_new_local_index_incoming, const size_t* mpi_interfaces_new_side_incoming) -> void;
    ...
    template <unsigned int blockSize>
    __device__ 
    auto warp_reduce_2D(volatile size_t *sdata_0, volatile size_t *sdata_1, unsigned int tid) -> void;
    ...
    template <unsigned int blockSize>
    __global__ 
    auto reduce_mpi_outgoing_refine(size_t n, const bool* refine, const bool* refine_without_splitting, size_t* g_odata) -> void;
}}}
