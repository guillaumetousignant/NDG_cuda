...
~\cite{Bryan2014} % amr astrophysics ENZO
~\cite{Schive2010} % GPU amr astrophysics GAMER
~\cite{Schive2018} % GPU amr astrophysics GAMER2

~\cite{Wang2020} % CPU ray tracing of tree-based amr data
