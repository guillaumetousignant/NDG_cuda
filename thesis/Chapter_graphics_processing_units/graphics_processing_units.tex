...
\begin{figure}[H]
	...
	{\includesvg[width=0.45\textwidth]{Chapter_graphics_processing_units/media/mesh_0_after0_P2} \label{fig:mesh_left}}
	\hfill
	\subfloat[Second mesh block]
	{\includesvg[width=0.45\textwidth]{Chapter_graphics_processing_units/media/mesh_1_after0_P2} \label{fig:mesh_right}}
...
% Insert structured and unstructured meshes
