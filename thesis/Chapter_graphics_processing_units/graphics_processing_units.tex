...
\acrshort{acr:CUDA} cores, and are arranged in rows as \textit{\acrfullpl{acr:SM}}.
...
the \acrlongpl{acr:SM} of the GPU, and each thread of that block will be executed on a
