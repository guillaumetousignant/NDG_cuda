...
\begin{figure}[H]
	\centering
	\includesvg[width=0.81\textwidth]{Chapter_spectral_element_method/media/polynomials}
...
\begin{figure}[H]
	\centering
	\includesvg[width=0.81\textwidth]{Chapter_spectral_element_method/media/interpolants}
