...
\begin{algorithm}[H]
\begin{minted}
[bgcolor = vs_black, fontsize = \scriptsize, linenos, mathescape]
{cuda}
__global__
...
\end{minted}
\caption{\textbf{calculate\_wave\_fluxes:} Riemann solver for the wave equation fluxes.}
\label{alg:wave_fluxes}
\end{algorithm}
