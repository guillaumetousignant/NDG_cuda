...
is called the \textit{Galerkin spectral element method}. 
The method is discontinuous because it allows the
solution to be discontinuous at element boundaries, using fluxes between elements to
...
%This method can be formulated in both continuous and discontinuous versions. explain continuous oneWe choose to use the discontinuous .... WHY? 
