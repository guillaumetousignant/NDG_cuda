...
\begin{center}
	\vspace*{0.45cm} % vertical gap. *" makes sure Latex does not ignore the command. 
...
its high accuracy. Second, we use \textit{\acrfullpl{acr:GPU}} to perform our computations to
