...
Once the mesh has refined, the extrapolated values may not line up anymore, as seen on
...
change the polynomial order of faces, and keep the element and face references coherent. 