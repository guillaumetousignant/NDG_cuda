...
\begin{figure}[H]
	\centering
	\includesvg[width=0.8\textwidth]{Chapter_adaptive_mesh_refinement/media/refinement_offset}
	\caption{Moving elements: Two elements are h-refined (in red), the others are moved.}\label{fig:refinement_offset}
\end{figure}
