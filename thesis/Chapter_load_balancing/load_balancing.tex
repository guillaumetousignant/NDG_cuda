...
\begin{figure}[H]
	...
	\caption{Refinement with rotated element: The numbering is wrong. (a) Initial mesh (b) Refined mesh}
...
\begin{figure}[H]
	...
	\caption{Refinement with rotated element using local referential: This is not the next level curve. (a) Initial mesh (b) Refined mesh}
...
\begin{figure}[H]
	\centering
	\subfloat[Before refining]
	{\includesvg[width=0.4\textwidth]{Chapter_load_balancing/media/hilbert_level_1} \label{fig:hilbert_l1_c}}
	\hfill
	\subfloat[After refining]
