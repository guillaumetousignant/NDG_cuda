...
\begin{figure}[H]
	\centering
	\subfloat[Level 0]
	{\includesvg[width=0.25\textwidth]{Chapter_load_balancing/media/hilbert_level_0} \label{fig:hilbert_l0}}
	\hfill
	\subfloat[Level 1]
	{\includesvg[width=0.25\textwidth]{Chapter_load_balancing/media/hilbert_level_1} \label{fig:hilbert_l1}}
	\hfill
	\subfloat[Level 2]
	{\includesvg[width=0.25\textwidth]{Chapter_load_balancing/media/hilbert_level_2} \label{fig:hilbert_l2}}
