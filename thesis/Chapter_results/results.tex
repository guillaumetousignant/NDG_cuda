...
\acrshortpl{acr:GPU}, with a comparison with the same code running on \acrshortpl{acr:CPU} for a
...
are compared. The cases were computed using the Narval supercomputer.

\begin{figure}[H]
	\centering
	\subfloat[Solution time]
	{\includesvg[width=0.45\textwidth]{Chapter_results/media/adaptivity_time_N4_K16_A5}\label{fig:adaptivity_efficiency_A5_time}}
	\subfloat[Maximum error]
	{\includesvg[width=0.45\textwidth]{Chapter_results/media/adaptivity_error_N4_K16_A5}\label{fig:adaptivity_efficiency_A5_error}}
	\caption{\Acrlong{acr:AMR} performance: Simulation time and analytical error with refinement and increasing number of pre-conditioning steps. \(N_{initial} = 4\), \(K_{initial} = 16\), \(S = 5\), refinement interval = 5}\label{fig:adaptivity_efficiency_A5}
\end{figure}

\begin{figure}[H]
	\centering
	\subfloat[Solution time]
	{\includesvg[width=0.45\textwidth]{Chapter_results/media/adaptivity_time_N4_K16_A20}\label{fig:adaptivity_efficiency_A20_time}}
	\hfill
	\subfloat[Maximum error]
	{\includesvg[width=0.45\textwidth]{Chapter_results/media/adaptivity_error_N4_K16_A20}\label{fig:adaptivity_efficiency_A20_error}}
	\caption{\Acrlong{acr:AMR} performance: Simulation time and analytical error with refinement and increasing number of pre-conditioning steps. \(N_{initial} = 4\), \(K_{initial} = 16\), \(S = 5\), refinement interval = 20}\label{fig:adaptivity_efficiency_A20}
\end{figure}

\begin{figure}[H]
	\centering
	\subfloat[Solution time]
	{\includesvg[width=0.45\textwidth]{Chapter_results/media/adaptivity_time_N4_K16_A100}\label{fig:adaptivity_efficiency_A100_time}}
	\hfill
	\subfloat[Maximum error]
	{\includesvg[width=0.45\textwidth]{Chapter_results/media/adaptivity_error_N4_K16_A100}\label{fig:adaptivity_efficiency_A100_error}}
	\caption{\Acrlong{acr:AMR} performance: Simulation time and analytical error with refinement and increasing number of pre-conditioning steps. \(N_{initial} = 4\), \(K_{initial} = 16\), \(S = 5\), refinement interval = 100}\label{fig:adaptivity_efficiency_A100}
\end{figure}

\begin{figure}[H]
	\centering
	\subfloat[Solution time]
	{\includesvg[width=0.45\textwidth]{Chapter_results/media/adaptivity_time_N4_K16_A500}\label{fig:adaptivity_efficiency_A500_time}}
	\hfill
	\subfloat[Maximum error]
	{\includesvg[width=0.45\textwidth]{Chapter_results/media/adaptivity_error_N4_K16_A500}\label{fig:adaptivity_efficiency_A500_error}}
	\caption{\Acrlong{acr:AMR} performance: Simulation time and analytical error with refinement and increasing number of pre-conditioning steps. \(N_{initial} = 4\), \(K_{initial} = 16\), \(S = 5\), refinement interval = 500}\label{fig:adaptivity_efficiency_A500}
\end{figure}
...
\acrshortpl{acr:GPU}, yet the adaptive case shows performance improvements. This means that
...
The best number of pre-conditioning steps seems to be four for this case, as the target error is
...
\begin{figure}[H]
	\centering
	\subfloat[Solution time]
	{\includesvg[width=0.45\textwidth]{Chapter_results/media/adaptivity_time_N4_K16_C4}\label{fig:adaptivity_efficiency_C4_time}}
	\hfill
	\subfloat[Maximum error]
	{\includesvg[width=0.45\textwidth]{Chapter_results/media/adaptivity_error_N4_K16_C4}\label{fig:adaptivity_efficiency_C4_error}}
	\caption{\Acrlong{acr:AMR} performance: Simulation time and analytical error with four pre-conditioning steps and increasing refinement interval. \(N_{initial} = 4\), \(K_{initial} = 16\), \(S = 5\), pre-conditioning steps = 4}\label{fig:adaptivity_efficiency_C4}
\end{figure}
...
\begin{table}[H]
	...
	\begin{tabular}{ c c c c c c c }
		...
		High & \(7\) & \(62490\) & \(47130\) & \(3905.625\) & \(12.07\) \\
	\end{tabular}
...
\begin{figure}[H]
	\centering
	\includesvg[width=0.6\textwidth]{Chapter_results/media/load_balancing_threshold_N4_K16384_A20_L20_P16_S7}
...
\begin{figure}[H]
	\centering
	\includesvg[width=0.6\textwidth]{Chapter_results/media/load_balancing_threshold_N4_K16384_A20_L20_P16_T1.5}
...
\acrshortpl{acr:GPU} with increasing \(N\), and could guide how elements should be weighted
...
increase the workload of \acrshortpl{acr:GPU} and increase their performance. This has been observed
...
\acrshortpl{acr:GPU}. The mesh is refined every \(50\) timesteps, and load balanced with a imbalance
...
The rank indicates which of the \(16\) \acrshortpl{acr:GPU} is responsible for which part of the
mesh, and how it changes with time as the mesh is load balanced.

\begin{figure}[H]
	\centering
	\subfloat[\( t = 0 s\)]
	{\includegraphics[width=0.5\textwidth]{Chapter_results/media/cloud_t0}\label{fig:cloud_p_t0}}
	\hfill
	\subfloat[\( t = 0.2 s\)]
	{\includegraphics[width=0.5\textwidth]{Chapter_results/media/cloud_t0_2}\label{fig:cloud_p_t0_2}}
...
\begin{figure}[H]
	\centering
	\subfloat[\( t = 0 s\)]
	{\includegraphics[width=0.5\textwidth]{Chapter_results/media/cloud_split_level_t0}\label{fig:cloud_s_t0}}
	\hfill
	\subfloat[\( t = 0.2 s\)]
	{\includegraphics[width=0.5\textwidth]{Chapter_results/media/cloud_split_level_t0_2}\label{fig:cloud_s_t0_2}}
...
\begin{figure}[H]
	\centering
	\subfloat[\( t = 0 s\)]
	{\includegraphics[width=0.5\textwidth]{Chapter_results/media/cloud_N_t0}\label{fig:cloud_N_t0}}
	\hfill
	\subfloat[\( t = 0.2 s\)]
	{\includegraphics[width=0.5\textwidth]{Chapter_results/media/cloud_N_t0_2}\label{fig:cloud_N_t0_2}}
...
\begin{figure}[H]
	\centering
	\subfloat[\( t = 0 s\)]
	{\includegraphics[width=0.5\textwidth]{Chapter_results/media/cloud_rank_t0}\label{fig:cloud_rank_t0}}
	\hfill
	\subfloat[\( t = 0.2 s\)]
	{\includegraphics[width=0.5\textwidth]{Chapter_results/media/cloud_rank_t0_2}\label{fig:cloud_rank_t0_2}}
...
can observe that there are more h-refining elements around \acrshortpl{acr:GPU} \(6\) and \(8\),
...
curve ressembles the Hilbert curve, and improves locality.
...
\begin{figure}[H]
	\centering
	\subfloat[Circular domain]
	{\includegraphics[width=0.45\textwidth]{Chapter_results/media/airfoil_mesh_pre_condition_far}\label{fig:complex_mesh_pre_condition_far}}
	\hfill
	\subfloat[Airfoil]
	{\includegraphics[width=0.45\textwidth]{Chapter_results/media/airfoil_mesh_pre_condition_near}\label{fig:complex_mesh_pre_condition_near}}
...
\begin{figure}[H]
	...
	\subfloat[Pressure]
	{\includegraphics[width=0.45\textwidth]{Chapter_results/media/airfoil_pressure_near_t1_5}\label{fig:complex_mesh_solution_p}}
	\hfill
	\subfloat[Pressure \(\sigma \)]
	{\includegraphics[width=0.45\textwidth]{Chapter_results/media/airfoil_pressure_sigma_near_t1_5}\label{fig:complex_mesh_solution_sigma}}
...
\begin{figure}[H]
	...
	{\includegraphics[width=0.45\textwidth]{Chapter_results/media/airfoil_index_t1_5_single}\label{fig:complex_mesh_index}}
	\hfill
	\subfloat[Rank]
	{\includegraphics[width=0.45\textwidth]{Chapter_results/media/airfoil_rank_t1_5}\label{fig:complex_mesh_rank}}
...
This case end up performing \(281078\) time steps, and took 5h04 to complete. The mesh was refined
