...
\frac{1}{32}\) the size of the original cell, and up to a polynomial order \(N\) of 16.
...
refined uniformly up to the maximum level attained by the adaptive case. The mesh is split into 128
...
maximum error similar to the adaptive case. The mesh is split into 32 elements in the \(x\) and
\(y\) dimensions, for  \(K = 1024\), with a polynomial order  \(N\) of 10. It is shown as a dotted
line on the figures. Both the simulation time and the error against the analytical solution are
compared.
