...
First, the performance of the core spectral element method code on \acrshortpl{acr:GPU}, with a
comparison with the same code running on \acrshortpl{acr:CPU} is presented in
...
\acrshortpl{acr:CPU} and \acrshortpl{acr:GPU}. To test this use case, most of the following tests
...
\acrshort{acr:CPU} cores and 186 GB of memory across two Intel Gold 6148 \acrshortpl{acr:CPU}, and
four NVidia V100 SXM2 \acrshortpl{acr:GPU} with 16 GB of memory each. One such node totals about 2
...
and 128 GB of memory across two Intel E5-2650 V2 \acrshortpl{acr:CPU}, and one NVidia GTX 1070
