...
\begin{equation} \label{equ:wave_initial_conditions}
	...
	\end{bmatrix}
	e^{-\frac{ {\left[ k_x(x - x_0) + k_y(y - y_0) -ct \right]}^2} {d^2}}
\end{equation}

\noindent
Where \(c = 1\) is the speed of sound. \(k_x\) and \(k_y\) are the components of the wavevector
...
location of the wave. We use \(x_0, y_0 = -0.2\) so that the wave starts just outside of the domain.
