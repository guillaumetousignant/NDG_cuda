...
\usepackage[toc, section=section, nopostdot, nonumberlist, nogroupskip, acronym, order=letter, sanitizesort]{glossaries} % put glossaries in content
...
\begin{document}
    ...
    \setcounter{page}{2}
    % abstract -------------------------------------------------------------------------------------
    \include{Chapter_abstract/abstract2.tex}
    % ----------------------------------------------------------------------------------------------
