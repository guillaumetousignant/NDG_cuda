...
%\usepackage{FiraMono}                   % nice monospaced font
...
\include{glossary_entries.tex}  % define all symbols in a separated file.
\include{colours.tex}           % define all colours in a separated file

% Operator definitions 
\DeclareMathOperator{\CFL}{CFL}

% Code snippets
\usemintedstyle[cuda]{material}
